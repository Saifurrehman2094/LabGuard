interface ElectronAPI {
  ...
  getNetworkMode: () => Promise<any>;
  setNetworkMode: (mode: string) => Promise<any>;
  setNetworkServer: (serverHost: string) => Promise<any>;
  setNetworkDatabasePath: (databasePath: string) => Promise<any>;
  getNetworkDatabasePath: () => Promise<any>;
